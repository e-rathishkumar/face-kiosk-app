...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      await prefs.setString('kiosk_id', response['id'] ?? '');
      await prefs.setString('kiosk_token', response['access_token'] ?? '');
      await prefs.setString('kiosk_refresh_token', response['refresh_token'] ?? '');
      await prefs.setString('kiosk_role', response['role'] ?? '');
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.face_retouching_natural, size: 44.sp, color: Colors.white),
              ),
